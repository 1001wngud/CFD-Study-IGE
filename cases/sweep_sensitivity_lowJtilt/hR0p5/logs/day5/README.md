...
- 14_foamRun_ref_final_baselineHover_0to1000.log: baselineHover final run with extended low-J curve (0->1000).
- 14_diag_ref_final_window100.txt: Day5 final diagnostics on last 100 steps.
- 14_ref_final_window100.txt: Day5 final extracted metrics/status (window 100, status=ok).
